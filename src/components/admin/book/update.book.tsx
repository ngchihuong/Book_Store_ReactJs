...
export default function UpdateBook(props: IProps) {
    const { isModalUpdateOpen, setIsModalUpdateOpen, dataUpdate, setDataUpdate, refreshTable } = props;
    ...
    return (
        <>
            <Modal title="Cập nhật thông tin sách"
